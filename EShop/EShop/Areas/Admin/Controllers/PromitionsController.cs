...
namespace EShop.Areas.Admin.Controllers
{
    public class PromitionsController : Controller
    {
        ...
        // GET: Admin/Promitions
        public ActionResult Index()
        {
            return View(db.Promitions.ToList());
        }

        // GET: Admin/Promitions/Details/5
        ...
        // GET: Admin/Promitions/Create
        public ActionResult Create()
        {
            return View();
        }

        // POST: Admin/Promitions/Create
        ...
        // POST: Admin/Promitions/Delete/5
