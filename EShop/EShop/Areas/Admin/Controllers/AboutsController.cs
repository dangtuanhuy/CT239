...
namespace EShop.Areas.Admin.Controllers
{
    public class AboutsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "AboutId,AboutUs,AboutImg,AboutDetails")] About about)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "AboutId,AboutUs,AboutImg,AboutDetails")] About about)
        {
            if (ModelState.IsValid)
            {
